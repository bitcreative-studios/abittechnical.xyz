...
const HeroContent = tw.div`w-full h-full grid grid-rows-8 grid-cols-12 container mx-auto font-text`
const Brand = styled.div`
  writing-mode: vertical-lr;
  ${tw`font-medium tracking-wide text-primary text-lg`}
`
const TagLine = styled.div`
  writing-mode: vertical-lr;
  ${tw`col-start-10 col-end-13 row-start-2 row-end-4 font-medium`}
`
...
const Hero = () => (
  <div tw="md:h-[768px] w-full">
    <HeroContent>
      ...
      <h1 tw="w-full row-start-2 row-end-7 col-start-4 col-end-12 grid grid-rows-3 grid-cols-8  gap-x-5 font-heading  lg:text-[12rem] font-display font-medium  leading-tight uppercase">
      ...
      <div tw="row-start-6 pt-6 row-end-auto col-start-2 col-end-6">
